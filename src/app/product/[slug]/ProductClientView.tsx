            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mt: 1 }}>
              ...
              <ButtonBase
                onClick={() => {
                  ...
                  const text = `شوف المنتج ده: ${item.name}\n${url}`;
                ...
                sx={{
                  ...
                  '&:hover': { bgcolor: 'rgba(37, 211, 102, 0.2)', transform: 'scale(1.1)' }
                }}
              >
              ...
              <ButtonBase
                ...
                sx={{
                  width: 34, height: 34, borderRadius: '50%',
                  bgcolor: 'rgba(24, 119, 242, 0.1)', color: '#1877F2',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  transition: 'all 0.2s ease',
                  '&:hover': { bgcolor: 'rgba(24, 119, 242, 0.2)', transform: 'scale(1.1)' }
                }}
              >
              ...
              <ButtonBase
                ...
                sx={{
                  height: 34, borderRadius: '17px', px: 1.5,
                  bgcolor: isCopied ? 'rgba(16, 185, 129, 0.1)' : 'rgba(100, 116, 139, 0.08)',
                  color: isCopied ? '#10B981' : '#64748B',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5,
                  transition: 'all 0.2s ease',
                  '&:hover': { bgcolor: 'rgba(100, 116, 139, 0.15)' }
                }}
              >
